...
class TopologyFactory:
    ...
    def __init__(self, problem_constructor, island_size = 20, migrant_pool_size = 5, domain_qualifier=None, mc_host='localhost', mc_port=11211):
    ...
    def _processTopology(self,raw,algorithm_factory,topology_class):
        '''
    ...
    def createOneWayRing(self, algorithm_factory, number_of_islands = 100):
        ...
        '''
        g = self._processTopology(nx.cycle_graph(number_of_islands, create_using=nx.DiGraph()), algorithm_factory, DiTopology)
        return g
    ...
    def createBidirRing(self, algorithm_factory, number_of_islands = 100):
        ...
        '''
        g = self._processTopology(nx.cycle_graph(number_of_islands, create_using=nx.Graph()), algorithm_factory, Topology)
        return g
    ...
    def createBidirChain(self, algorithm_factory, number_of_islands = 100):
        ...
        '''
        g = self._processTopology(nx.path_graph(number_of_islands, create_using=nx.Graph()), algorithm_factory, Topology)
    ...
    def createLollipop(self, algorithm_factory, complete_subgraph_size = 100, chain_size = 10):
        ...
        g = self._processTopology(nx.lollipop_graph(complete_subgraph_size, chain_size, create_using=nx.Graph()), algorithm_factory, Topology)
        # label tail nodes
        endpoints = set()
        for n in g.nodes:
            if len(tuple(g.neighbors(n))) == 1:
    ...
    def create_12_Ring(self, algorithm_factory, number_of_islands = 100):
        '''
        ...
        return self._processTopology(g, algorithm_factory, Topology)


    def create_123_Ring(self, algorithm_factory, number_of_islands = 100):
        '''
    ...
    def createFullyConnected(self, algorithm_factory, number_of_islands = 100):
        '''
        A fully connected (complete) topology.
        '''
        return  self._processTopology(nx.complete_graph(number_of_islands, create_using=nx.Graph()), algorithm_factory, Topology)


    def createBroadcast(self, algorithm_factory, number_of_islands = 100, central_node = 1):
        '''
    ...
    def createHypercube(self, algorithm_factory, dimension = 10):
        ...
        '''
        return self._processTopology(nx.hypercube_graph(dimension), algorithm_factory, Topology)
    ...
    def createWattsStrogatz(self, algorithm_factory, num_nodes=100, k=10, p=0.1, seed = None):
        ...
        return self._processTopology(nx.watts_strogatz_graph(num_nodes,k,p,seed), algorithm_factory, Topology)
    ...
    def createErdosRenyi(self, algorithm_factory, num_nodes=100, p=0.1, directed = False, seed = None):
        ...
        '''
        seed = seed if seed is not None else randint(0,10000)
        return self._processTopology(nx.erdos_renyi_graph(num_nodes,p,seed,directed), algorithm_factory, Topology)
    ...
    def createBarabasiAlbert(self, algorithm_factory, num_nodes=100, m=3, seed = None):
        ...
        '''
        seed = seed if seed is not None else randint(0,10000)
        return self._processTopology(nx.barabasi_albert_graph(num_nodes,m,seed), algorithm_factory, Topology)
    ...
    def createExtendedBarabasiAlbert(self, algorithm_factory, num_nodes=100, m=3, p=0.3, q=0.1, seed = None):
        ...
        '''
        seed = seed if seed is not None else randint(0,10000)
        return self._processTopology(nx.extended_barabasi_albert_graph(num_nodes,m,p,q,seed), algorithm_factory, Topology)


    def createAgeingExtendedBarabasiAlbert(self, algorithm_factory, n=100, m=10, p=0.3, q=0.1, max_age=10, seed = None):
        '''
    ...
    def fromNetworkxGraph(self, algorithm_factory, g, directed=False):
        '''
        Create a custom topology from a networkx graph.
        '''
        return self._processTopology(g, algorithm_factory, DiTopology if directed else Topology)
